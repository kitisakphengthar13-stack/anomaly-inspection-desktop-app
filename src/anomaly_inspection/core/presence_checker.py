...
from anomaly_inspection.core.result_types import PresenceResult, PresenceStatus
from anomaly_inspection.core.zone_io import ZoneConfig, assert_zone_shape_matches, zones_to_mask
