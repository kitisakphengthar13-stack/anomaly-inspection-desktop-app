...
from anomaly_inspection.desktop.job_paths import DEFAULT_INSPECTION_JOB_NAME, make_job_slug
from anomaly_inspection.desktop.ui.theme import DEFAULT_THEME_NAME
