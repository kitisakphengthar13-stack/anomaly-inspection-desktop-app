...
from anomaly_inspection.core.pipeline import (
    CSV_FIELDNAMES,
    InspectionPipeline,
...
from anomaly_inspection.core.zone_io import save_zones
...
def test_pipeline_passes_anomalib_model_with_keyword_arguments(tmp_path, monkeypatch):
    import anomaly_inspection.core.pipeline as pipeline_module
