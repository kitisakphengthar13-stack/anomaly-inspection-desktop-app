from anomaly_inspection.core.anomaly_validation import ValidationRow, compute_metrics, iter_labeled_images, run_anomaly_validation
from anomaly_inspection.core.config import InspectionConfig, ModelConfig, OutputConfig, PresenceConfig, ProjectConfig
...
def test_run_anomaly_validation_passes_explicit_anomalib_model(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("anomaly_inspection.core.anomaly_validation.AnomalyInferencer", FakeInferencer)
    (tmp_path / "good").mkdir()
