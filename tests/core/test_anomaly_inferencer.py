...
from anomaly_inspection.core.anomaly_inferencer import (
    AnomalyInferencer,
...
def test_anomaly_inferencer_ckpt_defaults_to_engine_backend(monkeypatch):
    ...
    monkeypatch.setattr("anomaly_inspection.core.anomaly_inferencer.AnomalibModelResolver", lambda: FakeResolver())
